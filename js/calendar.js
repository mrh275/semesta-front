    ...
    this.divId = t.RenderID ? t.RenderID : '[data-render="calendar"]', this.DaysOfWeek = t.DaysOfWeek ? t.DaysOfWeek : ["Min", "Sen", "Sel", "Rab", "Kam", "Jum", "Sab"], this.Months = t.Months ? t.Months : ["JAN", "FEB", "MAR", "APR", "MEI", "JUN", "JUL", "AGU", "SEP", "OKT", "NOV", "DES"];
    var e = new Date;
